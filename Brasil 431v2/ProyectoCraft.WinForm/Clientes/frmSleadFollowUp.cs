...
namespace ProyectoCraft.WinForm.Clientes {
    public partial class frmSLeadFollowUP : Form {
        private static frmSLeadFollowUP _instancia = null;
        public static frmSLeadFollowUP Instancia {
            get {
                if (_instancia == null)
                    _instancia = new frmSLeadFollowUP();
        ...
        private ClsSalesLead _Slead;
        public ClsSalesLead SalesLead {
            get {
                return _Slead;
            }
            set {
        ...
        private void CargarFollowUp() {
            var listado = LogicaNegocios.Clientes.clsClientesMaster.ObtenerFollowupActivosClientePorSalesLEad(SalesLead.Id);
