...
IF NOT  EXISTS (SELECT * FROM sysobjects WHERE name='COTIZACION_DIRECTA_OPCIONES') 
BEGIN 
...
IF NOT  EXISTS (SELECT * FROM sysobjects WHERE name='COTIZACION_DIRECTA_OPCIONES_DETALLES') 
BEGIN 
...
IF   EXISTS (SELECT * FROM sysobjects WHERE name='COTIZACION_DIRECTA_OPCIONES') 
BEGIN 

	update COTIZACION_DIRECTA_OPCIONES set ID_TIPO_SERVICIO=1
