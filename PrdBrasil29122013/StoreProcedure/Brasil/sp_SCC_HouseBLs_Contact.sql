Create Procedure sp_SCC_HouseBLs_Contact
...
select      @NumConso as 'Consolidada',
            ...
            '',
            Po_nome
From  Contact.dbo.HouseAdi h
Inner Join Contact.dbo.Chegada a on (ch_codigo = ha_codhouse)
Inner Join Contact.dbo.Portos p on (Po_Codigo = ch_origem)
Left Outer Join Contact.dbo.Cliente cl on (Cl_Codigo = Ch_Cnee)
Where Ha_CodConso = @CodMaster
 
Update      #Salida
Set         CotaNum = Cti_CotaNum
From  Contact.dbo.CotaImpGeral
