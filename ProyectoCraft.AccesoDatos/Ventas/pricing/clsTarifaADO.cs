...
namespace ProyectoCraft.AccesoDatos.Ventas.pricing
{
    public static class clsTarifaADO
    {
        ...
        public static ResultadoTransaccion ListarTarifas(ClsSolicitudCotizacionIndirecta solicitudCotizacionIndirecta)
        {
            ...
            try
            {
                ...
                while (dreader.Read())
                {
                    ...
                    //item.solicitudCotizacionIndirecta = Convert.ToInt32(dreader["IDCotizacion"]);
        ...
        public static ResultadoTransaccion GuardarTarifa(ClsSolicitudCotizacionIndirecta cot, ClsSolicitudCotizacionInDirectaOpciones tar)
        {
            ...
            try
            {
                ...
                objParams[2].Value = tar.FechaValidezInicio;
                objParams[3].Value = tar.FechaValidezFin;
                objParams[4].Value = tar.Agente;
                objParams[5].Value = tar.Comentario;
                objParams[6].Value = tar.ComentarioInterno;
                objParams[7].Value = tar.Estado;
                ...
                foreach (var listItem in tar.Detalle){
                    var foo = listItem as ClsSolicitudCotizacionInDirectaOpcionesDetalle;
                    GuardarDetalleTarifa(foo, conn, tar.Id);//pasarle la conexion, ademas el id.
                }
        ...
        private static void GuardarDetalleTarifa(ClsSolicitudCotizacionInDirectaOpcionesDetalle det, SqlConnection conn, long IdTar)
        {
            ResultadoTransaccion res = new ResultadoTransaccion();
            IList<ClsItem> listItems = new List<ClsItem>();
            try
        ...
        public static ResultadoTransaccion ActualizaTarifa(ClsSolicitudCotizacionIndirecta cot, ClsSolicitudCotizacionInDirectaOpciones tar)
        {
            ResultadoTransaccion res = new ResultadoTransaccion();
            IList<ClsItem> listItems = new List<ClsItem>();
            try
            {
                ...
                command.Parameters.AddWithValue("@FechaValidezInicio", tar.FechaValidezInicio);
                command.Parameters.AddWithValue("@FechaValidezFin", tar.FechaValidezFin);
