...
//using out = Microsoft.Office.Interop.Outlook;
...
namespace ProyectoCraft.WinForm.Utils
{
    public static class EnvioEmail
    {
        ...
        private static ResultadoTransaccion EnviaEmail(string toValue, string subjectValue, string bodyValue, List<object> attachments)
        {
            ...
            try
            {
                ...
                if (attachments != null){
                    ...
                    String sDisplayName = AppDomain.CurrentDomain.BaseDirectory + "prueba.pdf";
                    int iPosition = 1;
                    int iAttachType = (int)OlAttachmentType.olByReference;
                        //oMailItem.Attachments.Add()
                    oMailItem.Attachments.Add(sDisplayName,iAttachType, iPosition, sDisplayName);     
                    }
        ...
        {
            return EnviaEmail(toValue, subjectValue, bodyValue,null);
        }

        public static ResultadoTransaccion EnviarEmailConAdjunto(string toValue, string subjectValue, string bodyValue, List<Object> attachments)
        {
            return EnviaEmail(toValue, subjectValue, bodyValue, attachments);
        }


        #region comentario

        //se comenta codigo y se pasa a otra clase para evitar duplicidad de correos en el envio.
        /*
        public static ResultadoTransaccion EnviarAsignacionTargets(IList<clsMeta> ListaProspectos, clsUsuario objUserEmisor)
        {
        ...
        public static ResultadoTransaccion EnviarAsignacionSalesLead(IList<ClsSalesLead> ListaProspectos, clsUsuario objUserEmisor)
        {
        ...
        public static ResultadoTransaccion EnviarMailAvisoNewObservacionVendedor(clsUsuario ObjEmisor, clsUsuario ObjDestinatario, DateTime Fecha, string Observaciones, string NombreTarget, string DestinatariosCopia)
        {
            string Asunto = "";
            string EmailBody = "";
            string EmailAviso = "";
        ...
        public static ResultadoTransaccion EnviarMailAvisoCierreTarget(clsUsuario UsuarioAsigna, clsMeta Target, string Observacion)
        {
            string EmailDestinatario = "";
            string Asunto = "";
            string EmailBody = "";
        ...
        public static ResultadoTransaccion EnviarMailAvisoCancelacionTarget(clsUsuario UsuarioAsigna, clsMeta Target, string Observacion)
        {
            string EmailDestinatario = "";
            string Asunto = "";
            string EmailBody = "";
        ...
        public static ResultadoTransaccion EnviarMailAvisoNewObservacionGerente(clsUsuario ObjEmisor, clsUsuario ObjDestinatario, clsUsuario ObjAsignadorTarget, string DestinatariosCopia, DateTime Fecha, string Observaciones, string NombreTarget)
        {
            string Asunto = "";
            string EmailBody = "";
            string EmailAviso = "";
        ...
        public static ResultadoTransaccion EnviarMailAvisoNewObservacionSalesLeadGerente(clsUsuario ObjEmisor, clsUsuario ObjDestinatario, clsUsuario ObjAsignadorTarget, string DestinatariosCopia, DateTime Fecha, string Observaciones, string nombreSalesLead)
        {
            string Asunto = "";
            string EmailBody = "";
            string EmailAviso = "";
        ...
        /// <summary>
        /// Metodo para el envio de Email Convocatoria de Reunion.
        /// </summary>
        /// <param name="visita">Objeto Visita a confirmar</param>
        /// <param name="Confirmada">Valor Booleano. True=Visita confirmada sin planificarla. False=Visita planificada</param>        
        public static ResultadoTransaccion CrearConvocatoriaReunion(clsVisita visita, bool Confirmada, bool aNombreDe, bool AvisoVendedor)
        {
            ...
            try
            {
                if (agendaMeeting != null)
                {
                    ...
                    //    else
                    //    {
                    //        Recipient rec = agendaMeeting.Recipients.Add(visita.Vendedor.Email);
                    //        rec.Type = (int)OlMeetingRecipientType.olRequired;    
                    //    }                        
                    //}
        ...
        /// <summary>
        /// Metodo para el envio de Email convocatoria de reunion. Solo para visitas planificadas
        /// </summary>
        /// <param name="VisitaActual">Objeto Visita a planificar</param>        
        public static ResultadoTransaccion EnviarEmailVisitaPlanificacion(clsVisita VisitaActual, bool confirmada, bool aNombreDe)
        {
            ...
            email.Emisor = Base.Usuario.UsuarioConectado.Usuario.Email;
            ...
            resLog = LogicaNegocios.Calendarios.clsCalendarios.LogEmailVisita(email);

            return resEmail;
        }

        /// <summary>
        /// Metodo para el envio de Email visita confirmada a los asistentes Craft confirmados        
        /// A los usuarios no confirmados se les envia correo de cancelacion de visita
        /// </summary>
        /// <param name="VisitaActual">Objeto Visita confirmada</param>        
        public static ResultadoTransaccion EnviarEmailVisitaConfirmada(clsVisita VisitaActual)
        {
        ...
        public static ResultadoTransaccion EnviarEmailVisitaConfirmadaReunionInterna(clsVisita VisitaActual)
        {
        ...
        /// <summary>
        /// Metodo para el envio de Email visita confirmada a los asistentes del Cliente seleccionados
        /// </summary>
        /// <param name="VisitaActual">Objeto Visita confirmada</param>        
        public static ResultadoTransaccion EnviarEmailVisitaConfirmadaCliente(clsVisita VisitaActual)
        {
        ...
        /// <summary>
        /// Metodo para el envio de Email Visita Cancelada
        /// </summary>
        /// <param name="VisitaActual">Objeto Visita cancelada</param>        
        public static ResultadoTransaccion EnviarEmailVisitaCancelada(clsVisita VisitaActual)
        {
            Application outlookApp = new Application();
            MAPIFolder calendar = outlookApp.Session.GetDefaultFolder(OlDefaultFolders.olFolderCalendar);
            Items calendarItems = calendar.Items;
        ...
        /// <summary>
        /// Metodo para el envio de Email de Visita replanificada
        /// </summary>
        /// <param name="VisitaActual">Objeto Visita replanificada</param>
        /// <param name="inicio">no usado</param>
        /// <param name="termino">no usado</param>        
        public static ResultadoTransaccion ModificarVisitaOutlook(clsVisita VisitaActual, DateTime inicio, DateTime termino)
        {
            Application outlookApp = new Application();
            MAPIFolder calendar = outlookApp.Session.GetDefaultFolder(OlDefaultFolders.olFolderCalendar);
            Items calendarItems = calendar.Items;
        ...
        /// <summary>
        /// Metodo para el Envio de Informe de Visita a los asistentes confirmados.
        /// Ademas envia el informe a receptores fijos y a los encargados de los tipos de productos.
        /// </summary>
        /// <param name="informe">Objeto Informe de Visita</param>
        /// <param name="VisitaActual">Objeto Visita</param>
        public static void EnviarEmailInformeVisita(clsVisitaInforme informe, clsVisita VisitaActual)
        {
            ...
            try
            {
                ...
                {
                    clsUsuario usuario = LogicaNegocios.Usuarios.clsUsuarios.ObtenerUsuarioPorEmail(fijo);
                    if (usuario != null)
                    {
                ...
                IList<Entidades.Clientes.clsClientesProductos> productoscliente = null;

                if (VisitaActual.Cliente == null)
                    productoscliente = new List<clsClientesProductos>();
                else
                    productoscliente = LogicaNegocios.Clientes.clsClientesMaster.ObtenerProductosPreferidos(VisitaActual.Cliente.Id);
        ...
        /// <summary>
        /// Metodo para el envio de Email de receptores del informe
        /// </summary>
        /// <param name="VisitaActual">Objeto Visita</param>
        /// <param name="usuario">Usuario receptor del Informe</param>
        /// <param name="productos">Productos tratados en la visita</param>
        /// <param name="traficos">Traficos tratados en la visita</param>
        private static void EnviarInformeReceptoresFijos(clsVisita VisitaActual, clsUsuario usuario, string productos, string traficos, Enums.VisitaTipoEmail tipo)
        {
        ...
        public static string BodyAvisoVendedorVisitaOrganizada(clsVisita VisitaActual)
        {
        ...
        public static ResultadoTransaccion EnviarAvisoInformeRequiereRespuesta(IList<clsUsuario> usuarios, clsVisita visita)
        {
        ...
        public static ResultadoTransaccion EnviarEmailComentarioRespondidoPorVendedor(clsVisita visita, clsInformeComentario comentario)
        {
        ...
        public static ResultadoTransaccion EnviarEmailComentarioEnInforme(clsVisita visita, clsInformeComentario comentario, bool EsVendedor, clsUsuario usuario)
        {            
        ...
        public static ResultadoTransaccion EnviarEmailVendedorRespondeComentarioEnInforme(clsVisita visita, clsInformeComentario comentario, bool EsVendedor, clsUsuario usuario)
        {
        ...
        public static String ReplaceObjectsMailSalesLead(ClsSalesLead salesLead, String template)
        {
        ...
        public static String CrearCuerpoMailSalesLead(ClsSalesLead salesLead, String templatePath)
        {
        ...
        public static ResultadoTransaccion EnviarMaiSalesLead(ClsSalesLead salesLead)
        {
        ...
        public static ResultadoTransaccion EnviarMailPaperlessAsignacionUsuario1(Entidades.Paperless.PaperlessAsignacion asignacion)
        {
            ...
            try
            {
                ...
                if (asignacion.FechaETA != null)
                    sb.Replace("[FECHAETA]", asignacion.FechaETA.Value.ToShortDateString());
        ...
        public static ResultadoTransaccion EnviarMailPaperlessUsuario2ConfirmacionUsuario1(Entidades.Paperless.PaperlessAsignacion asignacion)
        {
        ...
        public static ResultadoTransaccion EnviarMailPaperlessUsuario2TerminaProceso(Entidades.Paperless.PaperlessAsignacion asignacion, Entidades.Paperless.PaperlessUsuario1HouseBLInfo info)
        {
            ...
            try
            {
                List<Entidades.Usuarios.clsUsuario> usuarios = new List<clsUsuario>();

                IList<clsUsuario> supdocumental;
                res = LogicaNegocios.Usuarios.clsUsuarios.ListarUsuarios(Enums.Estado.Habilitado, Enums.CargosUsuarios.SupervisorDocumental);
                if (res.Estado == Enums.EstadoTransaccion.Aceptada)
                    usuarios.AddRange((IList<clsUsuario>)res.ObjetoTransaccion);

                res = LogicaNegocios.Usuarios.clsUsuarios.ListarUsuarios(Enums.Estado.Habilitado, Enums.CargosUsuarios.SupervisorDeProcesos);
                if (res.Estado == Enums.EstadoTransaccion.Aceptada)
                    usuarios.AddRange((IList<clsUsuario>)res.ObjetoTransaccion);


                //Usuario conectado y que envia el email
                usuarios.Add(Base.Usuario.UsuarioConectado.Usuario);
        ...
        public static ResultadoTransaccion EnviarMailPaperlessRechazoAsignacion(Entidades.Paperless.PaperlessAsignacion asignacion)
        {
        ...
        /// <summary>
        /// Metodo log envio de correo.
        /// usado para visitas confirmadas(usuarios y cliente) e informe
        /// </summary>
        /// <param name="tipo"></param>
        /// <param name="Visita"></param>
        /// <returns></returns>
        public static ResultadoTransaccion LogEnviarEmail(Enums.VisitaTipoEmail tipo, clsVisita Visita, string cuerpo, string asunto)
        {
            ResultadoTransaccion res = new ResultadoTransaccion();
            ...
            res = LogicaNegocios.Calendarios.clsCalendarios.LogEmailVisita(email);
