Create Procedure sp_SCC_HouseBLs_Craft
...
select      @NumConso as 'Consolidada',
            ...
            '',
            Po_nome
From  CRAFT.dbo.HouseAdi h
Inner Join CRAFT.dbo.Chegada a on (ch_codigo = ha_codhouse)
Inner Join CRAFT.dbo.Portos p on (Po_Codigo = ch_origem)
Left Outer Join CRAFT.dbo.Cliente cl on (Cl_Codigo = Ch_Cnee)
Where Ha_CodConso = @CodMaster
 
Update      #Salida
Set         CotaNum = Cti_CotaNum
From  CRAFT.dbo.CotaImpGeral
