...
PE.Id IdExcepcion,
PHBL.Observacion
FROM PAPERLESS_USUARIO1_HOUSESBL PHBL
LEFT OUTER JOIN CLIENTES_MASTER_TIPO_CLIENTE TC
ON PHBL.IdTipoCliente = TC.Id
LEFT OUTER JOIN PAPERLESS_USUARIO1_EXCEPCIONES PE
ON PHBL.Id = PE.IdHouseBL
